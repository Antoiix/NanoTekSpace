...
Test(andComponent, test_false_false)
{
...
Test(andComponent, test_true_true)
{
...
Test(andComponent, test_true_false)
{
    TestUtils util("tests/FalseTristate.txt");
...
Test(andComponent, test_true_undefined)
{
...
Test(andComponent, test_undefined_undefined)
{
    TestUtils util("tests/UndefinedTristate.txt");
...
Test(andComponent, test_wrong_pin)
{
    TestUtils util("tests/UndefinedTristate.txt");
