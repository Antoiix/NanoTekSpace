...
nts::C4071Component::C4071Component(const std::string& name) : AComponent(14, name)
{}

static nts::Tristate orGate(nts::Tristate pin1, nts::Tristate pin2)
{
...
nts::Tristate nts::C4071Component::compute(std::size_t pin, const Map& map)
{
    ...
    {
    case 3:
        return orGate(this->_pins[1]->getState(), this->_pins[2]->getState());
    case 4:
        return orGate(this->_pins[5]->getState(), this->_pins[6]->getState());
    case 10:
        return orGate(this->_pins[8]->getState(), this->_pins[9]->getState());
    case 11:
        return orGate(this->_pins[12]->getState(), this->_pins[13]->getState());
    default:
        return Undefined;
    }
}
